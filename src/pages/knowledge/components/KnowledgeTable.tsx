...
const COMPLETED_STATUSES = new Set(['completed', 'success', 'available']);
  ...
  const columns: TableColumnsType<KnowledgeFileRecord> = [
    {
      ...
      render: (_, record) => (
        <div className="knowledge-table-list__file-cell">
          <span className="knowledge-table-list__file-icon">
            {getFormatIcon(getRecordFormat(record))}
          </span>
          <div className="knowledge-table-list__file-info">
            ...
            <span className="knowledge-table-list__sub-text">
              {record.document_id}
            </span>
          </div>
        </div>
